          ...
          <Container>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="ms-auto">
                <Nav.Link href="#">Local Properties</Nav.Link>
                <Nav.Link href="#">Explore Our Builders</Nav.Link>
                <Nav.Link href="#" className='active'>Post Property Free</Nav.Link>
              </Nav>
              <Nav className="ms-auto">
                <Button variant="create-profile-btn">Create Your Builder Profile</Button>
          ...
          <div className='container'>
            <div className='row'>
              ...
              <div className='col-12 col-md-3'>
                <div className='footer-box'>
                  <ul>
                    <li><a href='#'>Local Properties</a></li>
